...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-12 col-md-12 form-section">
            <div class="login-wrapper">
                <h2 class="login-title">Recupere sua senha</h2>
                <form method="POST" action="{{ route('login') }}">
                    @csrf
                    <div class="form-group"> <label for="email" class="sr-only">Email</label> <input type="email" name="email" id="email" class="form-control 
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-5"> <input name="login" type="submit" id="login" class="btn login-btn" type="button" value="Entrar"> <a href="{{ route('password.request') }}" class="forgot-password-link">Esqueceu sua senha?</a> 
                    @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                ...
                <p class="login-wrapper-footer-text">Não tem uma conta?<a href="{{ route('register') }}" class="text-reset">Cadastre-se</a></p>
            </div>
        </div>
    </div>
</div>
